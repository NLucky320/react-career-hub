...
const AppliedJob = ({ job }) => {
  return (
    <div className=" card bg-base-100 shadow-xl p-4 items-center flex md:flex-row justify-between gap-4">
         
             <div className="items-center text-center h-full p-4 w-[240px] bg-[#F4F4F4]">
